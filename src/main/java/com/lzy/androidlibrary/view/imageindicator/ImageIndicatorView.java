...
public class ImageIndicatorView extends RelativeLayout {
	 ...
	 *            Drawable array
	 */
	public void setupLayoutByDrawable(final Integer resArray[], boolean gesture) {
		if (resArray == null)
			throw new NullPointerException();

		this.setupLayoutByDrawable(Arrays.asList(resArray), gesture);
	}
	 ...
	 *            Drawable list
	 */
	public void setupLayoutByDrawable(final List<Integer> resList, boolean gesture) {
		if (resList == null)
			throw new NullPointerException();
