 ...
 * @desc
 */
public class LCircleMenuLayout extends ViewGroup {
    ...
    public LCircleMenuLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        // 无视padding
        setPadding(0, 0, 0, 0);
    ...
    public void setId_circle_menu_item_center(int id_circle_menu_item_center) {
